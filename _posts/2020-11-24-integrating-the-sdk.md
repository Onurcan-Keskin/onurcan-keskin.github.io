...
<p>You can download the codelab project from: <a href="https://github.com/Onurcan-Keskin/onurcan-keskin.github.io/tree/master" target="_blank">https://github.com/Onurcan-Keskin/onurcan-keskin.github.io/tree/master</a></p>

<h2><strong>Creating a Project</strong></h2>
<p><strong>Step 1</strong>: Start Android Studio.</p>
<p><strong>Step 2</strong>: Choose <strong>File</strong> &gt; <strong>Open</strong>, go to the directory where the sample project is decompressed, and click <strong>OK</strong>.<br><img style="width: 376.00px" src="https://github.com/Onurcan-Keskin/onurcan-keskin.github.io/blob/gh-pages/assets/s5.PNG?raw=true" onclick="imageclick(src)"></p>
...
<p><strong>2. Configure the dependency package in the app's pubsec.yaml file.</strong></p>
<ul>
    ...
    </span><span class="str">            //Account Kit</span><span class="pln">
		huawei_account: </span><span class="str">^5.0.3+303</span><span class="pln">
		</span><span class="pun">...</span><span class="pln">
	</span><span class="pln">
	</span></code></pre>
